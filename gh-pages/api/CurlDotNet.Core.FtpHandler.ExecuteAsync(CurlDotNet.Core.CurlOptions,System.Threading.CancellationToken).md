...
### [CurlDotNet\.Core](CurlDotNet.Core.md 'CurlDotNet\.Core').[FtpHandler](CurlDotNet.Core.FtpHandler.md 'CurlDotNet\.Core\.FtpHandler')

## FtpHandler\.ExecuteAsync\(CurlOptions, CancellationToken\) Method
...
<a name='CurlDotNet.Core.FtpHandler.ExecuteAsync(CurlDotNet.Core.CurlOptions,System.Threading.CancellationToken).options'></a>

`options` [CurlOptions](CurlDotNet.Core.CurlOptions.md 'CurlDotNet\.Core\.CurlOptions')

<a name='CurlDotNet.Core.FtpHandler.ExecuteAsync(CurlDotNet.Core.CurlOptions,System.Threading.CancellationToken).cancellationToken'></a>
