...
See the [Migration Guide](https://jacob-mellor.github.io/curl-dot-net/migration/httpclient.html) for detailed instructions on migrating from HttpClient to CurlDotNet.
