...
```bash
cd dotnet/tests/CurlDotNet.Tests
...
The `/dotnet/manual` folder contains markdown documentation:
...
1. Create a new `.md` file in `dotnet/manual/tutorials/`
2. Add it to `dotnet/manual/README.md` TOC
...
2. **Continue Documentation:**
   - Add more tutorial files to `dotnet/manual/`
