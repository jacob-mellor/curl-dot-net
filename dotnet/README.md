...
[![.NET Standard](https://img.shields.io/badge/.NET-Standard%202.0%20%7C%208.0%20%7C%20Framework%204.7.2-512BD4)](https://dotnet.microsoft.com/)
...
- **[Full Documentation](https://github.com/jacob-mellor/curl-dot-net/tree/main/dotnet/manual)** - Comprehensive guides and tutorials
- **[API Reference](https://github.com/jacob-mellor/curl-dot-net)** - Complete API documentation
- **[Examples Repository](https://github.com/jacob-mellor/curl-dot-net/tree/main/dotnet/examples)** - Real-world code examples
